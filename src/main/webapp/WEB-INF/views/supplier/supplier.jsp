...
<body>
	<s:form method="post" id="domainForm" action="/supplier.action">
		<div class="main-content">
			...
			<div class="page-content">
				<div class="page-header">
						...
						<a href="/supplier_input.action" class="btn btn-white">新增</a>
													...
													<td>
														<div
															class="visible-md visible-lg hidden-sm hidden-xs btn-group">
															 <a href="javascript:updateDomain('/supplier_input.action?id=${id}')" class="btn btn-xs btn-info">
																<i class="icon-edit bigger-120"></i>
															</a>
															<button type="button" onclick="deleteDomain('/supplier_delete.action?id=${id}',this)" class="btn btn-xs btn-danger">
