...
<script type="text/javascript">
	...
	//当前窗体如果不是等于最外层窗体
 	if (top != window) {
 		//给最外层窗体进行重定向（把当前窗体的url地址赋值给最外层窗体的url地址）
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="icon-leaf green"></i> <span class="red">源码时代</span> <span
											...
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" name="username" value="admin" class="form-control"
														placeholder="用户名" /> <i class="icon-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="password" name="password" value="admin" class="form-control"
