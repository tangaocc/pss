...
<body>
	<s:form method="post" id="domainForm" action="/dept.action">
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					...
					<li><a href="#">测试部门管理</a></li>
					<li class="active">测试部门列表</li>
				</ul>
			</div>
			...
			<div class="page-content">
				<div class="page-header">
						...
						<a href="/dept_input.action" class="btn btn-white">新增</a>
													...
													<td>
														<div
															class="visible-md visible-lg hidden-sm hidden-xs btn-group">
															 <a href="javascript:updateDomain('/dept_input.action?id=${id}')" class="btn btn-xs btn-info">
																<i class="icon-edit bigger-120"></i>
															</a>
															<button type="button" onclick="deleteDomain('/dept_delete.action?id=${id}',this)" class="btn btn-xs btn-danger">
