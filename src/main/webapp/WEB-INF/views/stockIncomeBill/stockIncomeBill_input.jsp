...
<!-- 引入自定义的js -->
<script type="text/javascript" src="/assets/model/stockIncomeBill.js"></script>
</head>
<body>
		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="stockIncomeBillForm" action="/stockIncomeBill_save.action" method="post" class="form-horizontal" role="form">
						<s:hidden name="id"/>
