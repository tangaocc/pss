...
<body>
	<s:form method="post" id="domainForm" action="/depot.action">
		<div class="main-content">
			...
			<div class="page-content">
				<div class="page-header">
						...
						<a href="/depot_input.action" class="btn btn-white">新增</a>
													...
													<td>
														<div
															class="visible-md visible-lg hidden-sm hidden-xs btn-group">
															 <a href="javascript:updateDomain('/depot_input.action?id=${id}')" class="btn btn-xs btn-info">
																<i class="icon-edit bigger-120"></i>
															</a>
															<button type="button" onclick="deleteDomain('/depot_delete.action?id=${id}',this)" class="btn btn-xs btn-danger">
