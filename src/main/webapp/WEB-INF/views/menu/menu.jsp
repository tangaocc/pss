...
<body>
	<s:form method="post" id="domainForm" action="/menu.action">
		<div class="main-content">
			...
			<div class="page-content">
				<div class="page-header">
						...
						<a href="/menu_input.action" class="btn btn-white">新增</a>
													...
													<td>
														<div
															class="visible-md visible-lg hidden-sm hidden-xs btn-group">
															 <a href="javascript:updateDomain('/menu_input.action?id=${id}')" class="btn btn-xs btn-info">
																<i class="icon-edit bigger-120"></i>
															</a>
															<button type="button" onclick="deleteDomain('/menu_delete.action?id=${id}',this)" class="btn btn-xs btn-danger">
