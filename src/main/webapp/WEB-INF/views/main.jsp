				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="${user_in_session.headImage}" alt="Jason's Photo" /> <span
							class="user-info"> <small>欢迎光临,</small> ${user_in_session.username}
						...
						<ul
							...
							<li><a href="/login_out.action"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
					...
					<s:iterator value="#menus">
						<li>
							<a href="#" class="dropdown-toggle" > <i
									class="${icon}"></i> <span class="menu-text">${name} </span>
							...
							<ul class="submenu">
								<s:iterator value="children">
									<li>
										<a href="${url}" target="main"> <i
												class="icon-double-angle-right"></i>${name}
										</a>
									</li>
								</s:iterator>
							</ul>
