...
<!-- 引入自定义的js -->
<script type="text/javascript" src="/assets/model/permission.js"></script>
</head>
<body>
		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="permissionForm" action="/permission_save.action" method="post" class="form-horizontal" role="form">
						<s:hidden name="id"/>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-field-1">方法</label>

							<div class="col-sm-9">
								<s:textfield name="method"/><span style="color:red"></span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
							...
							<div class="col-sm-9">
								<s:textarea name="desc" cssStyle="resize:none;" rows="3" cols="30"></s:textarea>
							</div>
						</div>
