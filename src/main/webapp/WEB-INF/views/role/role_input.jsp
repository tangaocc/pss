...
<!-- 引入自定义的js -->
<script type="text/javascript" src="/assets/model/role.js"></script>
</head>
<body>
		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					...
					<form id="roleForm" action="/role_save.action" method="post" class="form-horizontal" role="form">
						<s:hidden name="id"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<s:checkboxlist name="permissions.id" value="permissions.{id}" list="#allPermissions" listKey="id" listValue="name"/>
							</div>
						</div>
